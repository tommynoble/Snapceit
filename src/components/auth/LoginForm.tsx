  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof FirebaseError) {
        ...
        setError('We\'re having trouble connecting to our services. Please try again in a moment.');
      }
      ...
      >
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl">
          <div className="flex flex-col items-center mb-2 sm:mb-4">
            ...
            /> */}
            <h2 className="text-lg sm:text-xl font-medium text-white/90 text-center">Log in to Snapceit</h2>
          </div>
