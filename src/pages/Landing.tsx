...
import { Camera, Tag, RefreshCw } from 'lucide-react';
                  ...
                  <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
                    <div className="flex flex-col justify-center min-h-[360px] relative order-2 md:order-1 md:-ml-8">
                      {[
                        ...
                        >
                          <div className={`inline-flex gap-2 text-xs font-medium rounded-full mb-6 px-3 py-1 backdrop-blur-md border ${slide.tone === 'purple'
